...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;HTTP-BROWSER https://sex.com 500 60`")
...
exec(`node HTTP-BROWSER.js ${host} ${threads} ${duration}`, (error, stdout, stderr) => {
});
